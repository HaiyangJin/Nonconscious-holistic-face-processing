...
# save(glmm.max.acc, file = "P101_acc_glmm_max.RData")
...
# glmm.zcp1.acc <- update(glmm.zcp.acc, start = pars.zcp.acc)
# 
# # Save the zcp2 model
# print("Saving the glmm.zcp2.acc ...")
# save(glmm.zcp.acc, glmm.zcp1.acc, file = "P101_acc_glmm_zcp.RData")
