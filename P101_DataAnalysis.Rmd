...
rt.ColuPlot.E1 = {
  ggplot(data = desc.scf.rt.R.E1, aes(y = Mean, x = Viewing, fill = Alignment)) +  # set the data, varialbes for x and y axises, and the variable for dividing data
    ...
    scale_y_continuous(expand= c(0, 0)) +  # remove the space between columns and x axis
    # facet_grid(. ~ Viewing, switch = "both") +
    labs(title = "Experiment 1 (Standard design)", x = "Viewing Conditions", y = "Correct Response Times (ms)") +  # set the names for main, x and y axises
...
rt.ColuPlot.E3 = {
  ggplot(data = desc.scf.rt.R.E3, aes(y = Mean, x = Viewing, fill = Alignment)) +  # set the data, varialbes for x and y axises, and the variable for dividing data
    geom_col(position = "dodge", color = "#000000") + # width = .5, position = position_dodge(width = -0.5),
    scale_fill_manual(values=c("grey40", "grey60")) +
    geom_errorbar(mapping = aes(ymin = SE.lo, ymax = SE.hi), linetype = 1,  # set the error bar
                  position = position_dodge(width=0.9), show.legend = FALSE, width = 0.15, alpha = .5) + # ,                   
    ...
    scale_y_continuous(expand= c(0, 0)) +  # remove the space between columns and x axis
    # facet_grid(. ~ Viewing, switch = "both") +
    labs(title = "Experiment 3 (Standard design)", x = "Viewing Conditions", y = "Correct Response Times (ms)") +  # set the names for main, x and y axises
    geom_text(label = c("*", "", "", ""), color = "red", size = 6, nudge_y = 50) + # add starts to the significant columns
    theme_bw() +
    plot_theme
}
...
acc.ColuPlot.E4 = {
  ggplot(data = desc.acc.R.E4, aes(y = Mean, x = Alignment)) +  # set the data, varialbes for x and y axises, and the variable for dividing data
    ...
    labs(title = "Accuracy (Standard Design) for Experiment 1", x = "Viewing Conditions", y = "Accuracy") +  # set the names for main, x and y axises
    scale_fill_grey() +  # set the color for columns
    geom_text(label = c("", "", "***", ""), color = c("blue", "red", "red", "red"), size = 6, nudge_y = 0.15, nudge_x = 0.5) + # add starts to the significant columns
    theme_bw() +
    plot_theme
}
...
rt.ColuPlot.E4 = {
  ggplot(data = desc.scf.rt.R.E4, aes(y = Mean, x = Viewing, fill = Alignment)) +  # set the data, varialbes for x and y axises, and the variable for dividing data
    geom_col(position = "dodge", color = "#000000") + # width = .5, position = position_dodge(width = -0.5),
    scale_fill_manual(values=c("grey40", "grey60")) +
    geom_errorbar(mapping = aes(ymin = SE.lo, ymax = SE.hi), linetype = 1,  # set the error bar
                  position = position_dodge(width=0.9), show.legend = FALSE, width = 0.15, alpha = .5) + # ,                   
    ...
    scale_y_continuous(expand= c(0, 0)) +  # remove the space between columns and x axis
    # facet_grid(. ~ Viewing, switch = "both") +
    labs(title = "Experiment 4 (Standard design)", x = "Viewing Conditions", y = "Correct Response Times (ms)") +  # set the names for main, x and y axises
    geom_text(label = c("", "", "**", ""), color = "red", size = 6, nudge_y = 50) + # add starts to the significant columns
    theme_bw() +
    plot_theme
}
