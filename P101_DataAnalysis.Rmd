...
## the filename of the raw data file 
fn.raw.E3 <- file.path(folder.data, "E111_n-21_exp-2_2019-02-25-1002.csv")
...
file.max.acc <- file.path(folder.nesi, "P101_acc_glmm_max.RData")
...
file.max2.acc <- file.path(folder.nesi, "P101_acc_glmm_max2.RData")
...
file.zcp.acc <- file.path(folder.nesi, "P101_acc_glmm_zcp.RData")
...
file.zcp2.acc <- file.path(folder.nesi, "P101_acc_glmm_zcp2.RData")
...
file.rdc.acc <- file.path(folder.nesi, "P101_acc_glmm_rdc.RData")
...
file.rdc2.acc <- file.path(folder.nesi, "P101_acc_glmm_rdc2.RData")
...
file.etd.acc <- file.path(folder.nesi, "P101_acc_glmm_etd.RData")
...
file.etd2.acc <- file.path(folder.nesi, "P101_acc_glmm_etd2.RData")
...
```{r}
# extended model for accuarcy
# file.etd3.acc <- file.path(folder.nesi, "P101_acc_glmm_etd3.RData")
# 
