...
#   glmm.zcp2.resp <- update(glmm.zcp.resp, start = pars.zcp.resp)
# 
# } else {
#   load(file.zcp.resp)
# }
# 
# print(summary(glmm.zcp.resp), corr = FALSE)
```

```{r zcp model 2 for responses}
...
```{r reduced model 2 for responses}
# # reduced model 2 for responses (start from parameters of glmm.rdc.resp)
# file.rdc2.resp <- file.path(folder.nesi, "P101_resp_glmm_rdc2.RData")
# 
# if (!file.exists(file.rdc2.resp)) {
#   pars.rdc.resp <- get_pars(glmm.rdc.resp)
#   
#   glmm.rdc2.resp <- update(glmm.rdc.resp, start = pars.rdc.resp)
#   
#   save(glmm.rdc2.resp, file = file.rdc2.resp)
# } else {
#   load(file.rdc2.resp)
# }
# 
# print(summary(glmm.rdc2.resp), corr = FALSE)

```


```{r}
anova(glmm.zcp2.resp, glmm.rdc2.resp)
```
...
#                          verbose = FALSE)
#   
#   save(glmm.etd.resp, file = file.etd.resp)
# } else {
#   load(file.etd.resp)
# }
# 
...
```{r extended model 2 for respuarcy}
# # extended model 2 for respuarcy (start from parameters of glmm.etd.resp)
...
#   
#   save(glmm.etd2.resp, file = file.etd2.resp)
# } else {
#   load(file.etd2.resp)
# }
# 
# print(summary(glmm.etd2.resp), corr = FALSE)

```

```{r}
summary(rePCA(glmm.etd2.resp))
```
