...
#### Contrasts
```{r}
contrast(emm.acc, "pairwise", simple = "each", combine = TRUE, adjust = "bonferroni")
```
...
```{r}
lmm.zcp.d <- lmer(dprime ~ Viewing * Congruency * Alignment + ExpCode +
                    (1 + View_D + Con_D + Ali_D + View_Con + View_Ali + Con_Ali || Participant), 
                  data = d.R.all)
...
```{r}
lmm.rdc.d <- lmer(dprime ~ Viewing * Congruency * Alignment + ExpCode +
...
```{r}
lmm.rdc1.d <- lmer(dprime ~ Viewing * Congruency * Alignment + ExpCode +
...
```{r}
lmm.etd.d <- lmer(dprime ~ Viewing * Congruency * Alignment + ExpCode +
                    (1 + View_D + Con_D + Con_Ali | Participant), 
                  data = d.R.all)
...
```{r}
emm.d.all <- emmeans(lmm.etd.d, ~ Alignment | c(Congruency, Viewing))
...
# lmm.zcp.rt <- lmer(reactionTime ~ Viewing * Congruency * Alignment + ExpCode +
#                      (1 + View_D + Con_D + Ali_D + View_Con + View_Ali + Con_Ali + View_Con_Ali | Participant) +
#                      (1 + View_D + Con_D + Ali_D + View_Con + View_Ali + Con_Ali + View_Con_Ali | FaceGroup),
#                    data = df.cf.rt,
#                    REML = FALSE,
