...
if (!file.exists(file.max.acc)) {
  ...
  glmm.max1.acc <- update(glmm.max.acc, start = pars.max.acc)
...
print(summary(glmm.max1.acc), corr = FALSE)
...
# print(summary(glmm.zcp1.acc), corr = FALSE)

```


```{r PCA for zcp model}
summary(rePCA(glmm.zcp1.acc))
